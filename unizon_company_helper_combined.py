...
def generate_pdf(data):
    ...
    pdf.cell(200, 10, txt="نتيجة مساعد تأسيس شركة - يوني زون", ln=True, align='C')
    pdf.ln(10)
    for label, value in data.items():
        pdf.cell(200, 10, txt=f"{label}: {value}", ln=True)
    output_path = "/tmp/full_company_report.pdf"
...
if submitted:
    ...
    with open(pdf_path, "rb") as f:
        ...
        href = f'<a href="data:application/pdf;base64,{b64}" download="مساعد_تأسيس_شركة_يونى_زون.pdf">📥 تحميل النتيجة PDF</a>'
